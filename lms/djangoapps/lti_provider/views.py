...
from lms.djangoapps.lti_provider.models import LtiConsumer, log_lti_launch, get_rutgers_code
...
from lms.djangoapps.lti_provider.users import UserService, update_lti_user_data
...
def test_launch(request):
    ...
    template = Template(render_to_string('static_templates/lti_debug.html', {
        'disable_accordion': True,
        'allow_iframing': True,
        'disable_header': True,
        'disable_footer': True,
