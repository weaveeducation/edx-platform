...
def get_score(submissions_scores, csm_scores, persisted_block, block):
    ...
    if data:
        raw_earned, raw_possible, weighted_earned, weighted_possible, attempted = data
    else:
        data = _get_score_from_csm(csm_scores, block, weight)
        if data:
            raw_earned, raw_possible, weighted_earned, weighted_possible, attempted, last_answer_timestamp = data
        else:
