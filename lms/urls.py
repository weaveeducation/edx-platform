...
from courseware.views.views import CourseTabView, EnrollStaffView, StaticCourseTabView,\
    cookie_check, launch_new_tab, render_xblock_course, block_student_progress, email_student_progress, block_student_progress_test
...
urlpatterns += [
    ...
    url(
        r'^courses/{course_key}/block_student_progress_test/{usage_key}/?$'.format(
            course_key=settings.COURSE_ID_PATTERN,
            usage_key=settings.USAGE_ID_PATTERN,
        ),
        block_student_progress_test,
        name='block_student_progress_test',
    ),
