...
CELERY_RESULT_BACKEND = ENV_TOKENS.get('CELERY_RESULT_BACKEND', 'django-db')
...
CSRF_COOKIE_SAMESITE = DCS_SESSION_COOKIE_SAMESITE
...
DASHBOARD_COURSE_LIMIT = ENV_TOKENS.get('DASHBOARD_COURSE_LIMIT', 50)
