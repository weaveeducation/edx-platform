...
define([
    ...
    'text!templates/copy-to-other-course.underscore',
],
    ...
    var CopyXblockModal = BaseModal.extend({
        ...
        initialize: function() {
            ...
            this.fetchCourseListing().done(function(data) {
                ...
                self.$('.course-listing-data').html(_.template(CopyToOtherCourseTemplate)({courses: data}));
