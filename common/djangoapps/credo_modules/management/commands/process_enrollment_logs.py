    ...
    def handle(self, *args, **options):
        ...
        while process:
            ...
            with transaction.atomic():
                ...
                if last_log_time:
                    TrackingLogConfig.update_setting('last_enrollment_log_time', last_log_time.isoformat().replace('T', ' '))

        TrackingLogConfig.update_setting('update_enrollment_process_num', '1')
        TrackingLogConfig.update_setting('update_enrollment_time', int(time.time()))
