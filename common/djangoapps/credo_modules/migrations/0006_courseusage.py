    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_usage_time', models.DateTimeField(null=True, verbose_name='First Usage Time', blank=True)),
                ('last_usage_time', models.DateTimeField(null=True, verbose_name='Last Usage Time', blank=True)),
